...
const ContactMe = () => {
  ...
  const handleSubmitForm = async (): Promise<void> => {
    sendEvent({ event: "contact_form_submitted", category: Email });
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 bg-accent">
        <div className="m-6 lg:m-12">
          ...
          <div className="mt-4 lg:mt-44">
            <div className="flex items-center gap-1 m-1 w-fit">
              <Link
              ...
              <button
                ...
                onClick={() =>
                  copyContact(
                    "LinkedIn profile",
                    "https://www.linkedin.com/in/thisisaditya-mehrotra/",
                  )
                }
                className="rounded p-1 text-reddish hover:bg-reddish/10 focus:outline-none focus:ring-2 focus:ring-reddish"
                aria-label="Copy LinkedIn profile link"
                title="Copy LinkedIn profile link"
              >
                {copiedContact === "LinkedIn profile" ? (
            ...
            <div className="flex items-center gap-1 m-1 w-fit">
              ...
              <button
                type="button"
                onClick={() =>
                  copyContact("Email address", "adityamehrotra6@gmail.com")
                }
                className="rounded p-1 text-reddish hover:bg-reddish/10 focus:outline-none focus:ring-2 focus:ring-reddish"
                aria-label="Copy email address"
                title="Copy email address"
              >
                {copiedContact === "Email address" ? (
                  <Check size={18} aria-hidden="true" />
                ) : (
                  <Copy size={18} aria-hidden="true" />
                )}
            ...
            <div className="flex items-center gap-1 m-1 w-fit">
              ...
              <button
                ...
                onClick={() =>
                  copyContact(
                    "GitHub profile",
                    "https://github.com/aditya-mehrotra",
                  )
                }
                className="rounded p-1 text-reddish hover:bg-reddish/10 focus:outline-none focus:ring-2 focus:ring-reddish"
